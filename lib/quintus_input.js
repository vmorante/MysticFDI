    ...
    Quintus.Input = function(Q) {
        ...
        Q.InputSystem = Q.Evented.extend({
            ...
            drawButtons: function() {
                ...
                for (var i = 0; i < keypad.controls.length; i++) {
                    ...
                    if (control[0]) {
                        ctx.font = "bold " + (keypad.size / 2) + "px western";
        ...
        Q.component("stepControls", {
            ...
            collision: function(col) {
                var p = this.entity.p;
                if (p.stepping && !col.obj.isA("Energia")) {
                    p.stepping = false;
                    p.x = p.origX;
                    p.y = p.origY;
                    Q.state.inc("energia", 1);
                }
            ...
            step: function(dt) {
                ...
                if (t > 0.70) {
                    if (Q.inputs['left'] && !Q.inputs['up'] && !Q.inputs['down']) {
